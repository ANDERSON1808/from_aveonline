    ...
    <div class="container mx-auto max-w-md shadow-md hover:shadow-lg transition duration-300">
      <div class="py-12 p-10 bg-white rounded-xl">
        ...
        <div class="mb-6">
          ...
          <input type="number" step="0.1" @blur="validate('percentaje')" :class="validateClass.percentaje"
                 v-model="promotion.percentaje"/>
        </div>
        <div class="mb-6">
          <label class="mr-4 text-gray-700 font-bold inline-block mb-2">Fecha de Inicio:</label>
          <input type="timestamp" @blur="validate('fecha_inicio')" :class="validateClass.fecha_inicio"
                 v-model="promotion.fecha_inicio"/>
        </div>
        <div class="mb-6">
          <label class="mr-4 text-gray-700 font-bold inline-block mb-2">Fecha de Final:</label>
          <input type="timestamp" @blur="validate('fecha_fin')" :class="validateClass.fecha_fin"
                 v-model="promotion.fecha_fin"/>
        </div>
        <button
