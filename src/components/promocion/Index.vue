<template>
  <div>
      <router-link to="/promociones/crear" class="py-3 px-2 bg-indigo-300 text-white font-bold rounded"><font-awesome-icon icon="plus-circle" /> Crear Nuevo </router-link>
